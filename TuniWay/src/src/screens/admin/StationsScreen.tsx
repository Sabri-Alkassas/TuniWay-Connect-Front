    ...
    <SafeAreaView style={s.safe} edges={['top']}>
      <View style={s.root}>
        <View style={s.iconWrap}>
          <AppIcon family="Feather" name="map-pin" size={28} color={colors.blue} />
        </View>
        <Text style={s.title}>Gestion des stations</Text>
...
const s = StyleSheet.create({
  ...
  iconWrap: { width: 72, height: 72, borderRadius: 20, backgroundColor: '#e6f1fb', alignItems: 'center', justifyContent: 'center', marginBottom: 16 },
